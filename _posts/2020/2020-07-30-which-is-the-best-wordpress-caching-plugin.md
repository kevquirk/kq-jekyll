...
categories:
  - Technology
---
I've talked about [how I optimise this site](/how-i-optimise-my-website-performance/) before, but I wanted to do some digging into which is the best WordPress caching plugin. I've tested some of the most popular caching plugins available, and decided to write this post with the results.
...
There are a lot of caching plugins available for WordPress, but for this test I went with the 4 most popular plugins I could find, which are:
  ...
  4. <a aria-label="undefined (opens in a new tab)" href="https://wp-rocket.me" target="_blank" rel="noreferrer noopener">WP Rocket</a> (premium plugin)
...
![](/assets/images/test-site-gtmetrix-results.png)
...
<table>
  ...
  <tr>
    <td>
      <a href="https://wp-rocket.me" target="_blank" aria-label="undefined (opens in a new tab)" rel="noreferrer noopener"><strong>WP Rocket</strong></a>
    </td>
...
So I decided to carry out the same tests on one of my posts. My most recent post, [Synology vs Nextcloud](/synology-vs-nextcloud-which-is-better-for-a-home-server/), seemed a good candidate.

It's 1,400 words, 3 images and 66 comments (each with an avatar). This means that the WordPress caching has to do a lot more work because it's loading things like analytics, an advert and commenter avatars. It's also doing some [IndieWeb](/implementing-the-indieweb-into-my-website/) goodness too.
...
<table>
  ...
  <tr>
    <td>
      <strong><a href="https://wp-rocket.me" target="_blank" aria-label="undefined (opens in a new tab)" rel="noreferrer noopener">WP Rocket</a></strong>
    </td>
...
Having said that, the server this site runs on is a VPS that's under resourced, so even without caching, WordPress will still loads fairly quickly. If you want more info on my hosting setup, here's a post about [what it costs me to run this blog](/how-much-does-it-cost-to-run-this-blog/), which explains it all.
...
I think the most important lesson I've learned from this testing is that **caching is not a magic pill that fixes all performance issues**. I already have a good quality server, and [I optimise this site in a number of ways](/how-i-optimise-my-website-performance/), not just caching.
...
WP Rocket offers a free trial, so [you can still give it a go](https://wp-rocket.me), but make sure you test other WordPress caching plugins too, as you may be able to gain more performance with one of the free offerings. Not to mention a few dollars too!
