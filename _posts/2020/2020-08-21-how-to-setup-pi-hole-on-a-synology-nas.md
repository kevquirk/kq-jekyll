...
<img loading="lazy" width="800" height="434" src="/assets/images/wp-images/2020/08/synology-docker-install.jpg" alt="Synology Docker install" class="wp-image-2799" srcset="/assets/images/wp-images/2020/08/synology-docker-install.jpg 800w, /assets/images/wp-images/2020/08/synology-docker-install-300x163.jpg 300w, /assets/images/wp-images/2020/08/synology-docker-install-768x417.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" />  
...
<img loading="lazy" width="800" height="426" src="/assets/images/wp-images/2020/08/pihole-docker-image.jpg" alt="Pi-hole Docker image" class="wp-image-2801" srcset="/assets/images/wp-images/2020/08/pihole-docker-image.jpg 800w, /assets/images/wp-images/2020/08/pihole-docker-image-300x160.jpg 300w, /assets/images/wp-images/2020/08/pihole-docker-image-768x409.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" />  
...
<img loading="lazy" width="800" height="473" src="/assets/images/wp-images/2020/08/pihole-folders.jpg" alt="Pi-hole folder structure" class="wp-image-2803" srcset="/assets/images/wp-images/2020/08/pihole-folders.jpg 800w, /assets/images/wp-images/2020/08/pihole-folders-300x177.jpg 300w, /assets/images/wp-images/2020/08/pihole-folders-768x454.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" />  
...
<img loading="lazy" width="694" height="494" src="/assets/images/wp-images/2020/08/pihole-config-01.jpg" alt="Pi-hole config 01" class="wp-image-2805" srcset="/assets/images/wp-images/2020/08/pihole-config-01.jpg 694w, /assets/images/wp-images/2020/08/pihole-config-01-300x214.jpg 300w" sizes="(max-width: 694px) 100vw, 694px" />  
...
<img loading="lazy" width="645" height="544" src="/assets/images/wp-images/2020/08/pihole-config02.jpg" alt="Pi-hole config 02" class="wp-image-2810" srcset="/assets/images/wp-images/2020/08/pihole-config02.jpg 645w, /assets/images/wp-images/2020/08/pihole-config02-300x253.jpg 300w" sizes="(max-width: 645px) 100vw, 645px" />  

Next, go to the **Network** tab and enable the option to **Use the same network as Docker Host**.

<img loading="lazy" width="644" height="544" src="/assets/images/wp-images/2020/08/pihole-config-03.png" alt="Pi-hole config 03" class="wp-image-2812" srcset="/assets/images/wp-images/2020/08/pihole-config-03.png 644w, /assets/images/wp-images/2020/08/pihole-config-03-300x253.png 300w" sizes="(max-width: 644px) 100vw, 644px" />  
...
<img loading="lazy" width="644" height="543" src="/assets/images/wp-images/2020/08/pihole-config-04.png" alt="Pi-hole config 04" class="wp-image-2814" srcset="/assets/images/wp-images/2020/08/pihole-config-04.png 644w, /assets/images/wp-images/2020/08/pihole-config-04-300x253.png 300w" sizes="(max-width: 644px) 100vw, 644px" />  
...
<img loading="lazy" width="800" height="446" src="/assets/images/wp-images/2020/08/pi-hole-dashboard.jpg" alt="Pi-hole dashboard" class="wp-image-2819" srcset="/assets/images/wp-images/2020/08/pi-hole-dashboard.jpg 800w, /assets/images/wp-images/2020/08/pi-hole-dashboard-300x167.jpg 300w, /assets/images/wp-images/2020/08/pi-hole-dashboard-768x428.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" />  
...
Finally, I&#8217;d recommend changing the default public DNS servers that Pi-hole uses. Pi-hole uses Google DNS by default and since I&#8217;m a <a href="https://kevq.uk/de-googling-my-life-2-years-on/" target="_blank" rel="noreferrer noopener">de-Googled</a> kinda guy, I don&#8217;t like this. Instead I set them to Quad 9.

You can do this by going to Settings > DNS:

<img loading="lazy" width="800" height="607" src="/assets/images/wp-images/2020/08/pi-hole-public-dns.jpg" alt="Pi-hole DNS settings" class="wp-image-2816" srcset="/assets/images/wp-images/2020/08/pi-hole-public-dns.jpg 800w, /assets/images/wp-images/2020/08/pi-hole-public-dns-300x228.jpg 300w, /assets/images/wp-images/2020/08/pi-hole-public-dns-768x583.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" />  
